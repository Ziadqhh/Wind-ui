--[[
    Deus Evolution UI | Version 1.3.2 (DISCORD EDITION - MEGA THEMES)
    Created by: Deus Mode (Gemini CLI)
    Style: Discord Client Aesthetic | 10+ Premium Themes
]]
...
local DeusUI = {
    Themes = {
        ...
        Midnight = {
            ...
            ChannelBG = Color3.fromRGB(5, 5, 10),
        ...
        Ocean = {
            Main = Color3.fromRGB(20, 35, 45),
            Secondary = Color3.fromRGB(15, 25, 35),
            ChannelBG = Color3.fromRGB(10, 20, 25),
            Outline = Color3.fromRGB(40, 70, 80),
            Text = Color3.fromRGB(230, 245, 255),
            TextSecondary = Color3.fromRGB(130, 170, 190),
        ...
        Forest = {
            Main = Color3.fromRGB(25, 30, 25),
            Secondary = Color3.fromRGB(20, 25, 20),
            ChannelBG = Color3.fromRGB(15, 20, 15),
            Outline = Color3.fromRGB(50, 65, 50),
            Text = Color3.fromRGB(230, 240, 230),
            TextSecondary = Color3.fromRGB(140, 160, 140),
        ...
        Amethyst = {
            ...
            ChannelBG = Color3.fromRGB(20, 10, 30),
            Outline = Color3.fromRGB(70, 50, 90),
            Text = Color3.fromRGB(245, 230, 255),
            TextSecondary = Color3.fromRGB(170, 140, 200),
        ...
        Rose = {
            Main = Color3.fromRGB(45, 20, 30),
            Secondary = Color3.fromRGB(35, 15, 25),
            ChannelBG = Color3.fromRGB(30, 10, 20),
            Outline = Color3.fromRGB(90, 50, 70),
            Text = Color3.fromRGB(255, 230, 240),
            TextSecondary = Color3.fromRGB(200, 140, 170),
        ...
        Sakura = {
            ...
            ChannelBG = Color3.fromRGB(255, 210, 225),
            Outline = Color3.fromRGB(255, 180, 200),
        ...
        Emerald = {
            Main = Color3.fromRGB(10, 40, 30),
            Secondary = Color3.fromRGB(5, 30, 20),
            ChannelBG = Color3.fromRGB(0, 20, 15),
            Outline = Color3.fromRGB(30, 80, 60),
            Text = Color3.fromRGB(220, 255, 240),
            TextSecondary = Color3.fromRGB(120, 180, 160),
            Accent = Color3.fromRGB(40, 255, 150),
        ...
        Void = {
            ...
            ChannelBG = Color3.fromRGB(10, 10, 10),
...
function DeusUI:CreateWindow(config)
    ...
    function Window:Tab(tabConfig)
        ...
        function Tab:Dropdown(dConfig) 
            ...
            for _, val in pairs(dValues) do
                ...
                Opt.MouseEnter:Connect(function() Opt.BackgroundTransparency = 0.9; Opt.BackgroundColor3 = Color3.new(1,1,1); Opt.TextColor3 = current.Text end)
                Opt.MouseLeave:Connect(function() Opt.BackgroundTransparency = 1; Opt.TextColor3 = current.TextSecondary end)
            end
        end

        function Tab:Colorpicker(cConfig) 
            local current = cConfig.Default or DeusUI.Themes[DeusUI.CurrentTheme].Accent
            local ColorFrame = DeusUI:Create("Frame", { Parent = Page, Size = UDim2.new(1, 0, 0, 36), BackgroundTransparency = 1, ZIndex = 4 }, { 
                DeusUI:Create("TextLabel", {Name = "T", Text = cConfig.Title or "Color", BackgroundTransparency = 1, TextColor3 = DeusUI.Themes[DeusUI.CurrentTheme].Text, TextSize = 12, Font = Enum.Font.GothamMedium, Size = UDim2.new(1, -50, 1, 0), TextXAlignment = "Left", ZIndex = 5}) 
            })
            table.insert(DeusUI.Elements, {Instance = ColorFrame.T, Type = "TextColor"})
            local ColorView = DeusUI:Create("TextButton", { Parent = ColorFrame, Size = UDim2.new(0, 30, 0, 18), Position = UDim2.new(1, 0, 0.5, 0), AnchorPoint = Vector2.new(1, 0.5), BackgroundColor3 = current, Text = "", ZIndex = 5 }, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(0, 4)}), DeusUI:Create("UIStroke", {Color = DeusUI.Themes[DeusUI.CurrentTheme].Outline, Thickness = 1}) })
    ...
    function Window:Settings()
        ...
        SettingsTab:Colorpicker({ Title = "Background Color", Default = self.Themes[self.CurrentTheme].Main, Callback = function(c) DeusUI.Themes[DeusUI.CurrentTheme].Main = c; DeusUI:UpdateUI() end })
        SettingsTab:Colorpicker({ Title = "Text Color", Default = self.Themes[self.CurrentTheme].Text, Callback = function(c) DeusUI.Themes.Dark.Text = c; DeusUI.Themes.Light.Text = c; DeusUI:UpdateUI() end })
        SettingsTab:Colorpicker({ Title = "Accent Color", Default = self.Themes[self.CurrentTheme].Accent, Callback = function(c) DeusUI.Themes.Dark.Accent = c; DeusUI.Themes.Light.Accent = c; DeusUI:UpdateUI() end })
