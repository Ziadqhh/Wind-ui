...
function DeusUI:CreateWindow(cfg)
    ...
    local MainFrame = Create("CanvasGroup", {
        ...
        Create("UIStroke", {Color = theme.Outline, Thickness = 2, Transparency = 0.4})
    })
    ...
    local Sidebar = Create("Frame", {
        ...
        Size = UDim2.new(0, 200, 1, -75), Position = UDim2.new(0, 15, 0, 60),
        BackgroundColor3 = theme.Sidebar, BackgroundTransparency = 0.3
    }, {
    ...
    local PageContainer = Create("Frame", {
        ...
        Size = UDim2.new(1, -245, 1, -75), Position = UDim2.new(0, 230, 0, 60),
        BackgroundTransparency = 1
    })
    ...
    -- [WINDOW OBJECT]
    local Window = { SelectedTab = nil, Tabs = {} }
    ...
    function Window:Tab(tCfg)
        ...
        local TabBtn = Create("TextButton", {
            ...
            Size = UDim2.new(0.92, 0, 0, 48), BackgroundColor3 = theme.Secondary,
            BackgroundTransparency = 1, Text = "", AutoButtonColor = false
        }, {
            Create("UICorner", {CornerRadius = UDim.new(0, 14)}),
            Create("ImageLabel", {
                Name = "Icon", Image = tabIcon, Size = UDim2.new(0, 24, 0, 24),
                Position = UDim2.new(0, 15, 0.5, 0), AnchorPoint = Vector2.new(0, 0.5),
                BackgroundTransparency = 1, ImageColor3 = theme.TextDim
            }),
            Create("TextLabel", {
                Name = "Label", Text = tabName, Size = UDim2.new(1, -55, 1, 0),
                Position = UDim2.new(0, 50, 0, 0), BackgroundTransparency = 1,
        ...
        function Tab:Button(bCfg)
            local btnFrame = Create("Frame", {
                Parent = Page, Size = UDim2.new(0.96, 0, 0, 50),
                BackgroundColor3 = theme.Secondary, BackgroundTransparency = 0.4
            }, {
                Create("UICorner", {CornerRadius = UDim.new(0, 15)}),
                Create("UIStroke", {Color = theme.Outline, Thickness = 1.2, Transparency = 0.6}),
                Create("TextButton", {
            ...
            btnFrame.MainBtn.MouseButton1Down:Connect(function() 
                DeusUI:Tween(btnFrame, TweenInfo.new(0.1), {Size = UDim2.new(0.93, 0, 0, 46)}) 
            end)
            btnFrame.MainBtn.MouseButton1Up:Connect(function() 
                DeusUI:Tween(btnFrame, TweenInfo.new(0.2, Enum.EasingStyle.Elastic), {Size = UDim2.new(0.96, 0, 0, 50)}) 
        ...
        function Tab:Toggle(tCfg)
            ...
            local tFrame = Create("Frame", {
                ...
                Create("UICorner", {CornerRadius = UDim.new(0, 15)}),
                Create("TextLabel", {
                    Text = tCfg.Title or "Toggle", Position = UDim2.new(0, 20, 0, 0),
                ...
                Create("TextButton", {
                    Name = "Switch", Size = UDim2.new(0, 55, 0, 28),
                    ...
                    Create("Frame", {
                        Name = "Knob", Size = UDim2.new(0, 22, 0, 22),
