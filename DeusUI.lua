--[[
    Deus Evolution UI | Version 1.3.2 (COMPACT & ULTRA-ROUNDED)
...
function DeusUI:CreateWindow(config)
    ...
    function Window:Tab(tabConfig)
        ...
        local function SetTabState(state)
            ...
            DeusUI:Tween(TabBtn, TweenInfo.new(0.3), {BackgroundColor3 = targetColor})
            DeusUI:Tween(TabBtn.Content.Label, TweenInfo.new(0.3), {TextColor3 = textTarget})
            if TabBtn.Content:FindFirstChild("Icon") then DeusUI:Tween(TabBtn.Content.Icon, TweenInfo.new(0.3), {ImageColor3 = textTarget}) end
