    ...
    local function updateGlobalStyles()
        ...
        for _, el in pairs(DeusUI.Elements) do
            if el.Type == "TabBtn" then 
                ...
                DeusUI:Tween(el.Instance.Label, TweenInfo.new(0.3), {TextColor3 = textTarget})
                if el.Instance:FindFirstChild("Icon") then DeusUI:Tween(el.Instance.Icon, TweenInfo.new(0.3), {ImageColor3 = textTarget}) end
