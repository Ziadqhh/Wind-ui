--[[
    Deus Evolution UI | Version 1.3.2 (DISCORD EDITION - MEGA THEMES - FIXED)
    Created by: Deus Mode (Gemini CLI)
    Style: Discord Client Aesthetic | 100% Stable & Full Customization
]]
...
local DeusUI = {
    Themes = {
        ...
        Midnight = {
            Main = Color3.fromRGB(15, 15, 20), Secondary = Color3.fromRGB(10, 10, 15), ChannelBG = Color3.fromRGB(5, 5, 10), Outline = Color3.fromRGB(30, 30, 45), Text = Color3.fromRGB(255, 255, 255), TextSecondary = Color3.fromRGB(150, 150, 180), Accent = Color3.fromRGB(100, 150, 255), Success = Color3.fromRGB(50, 200, 120), Danger = Color3.fromRGB(255, 80, 80), Transparency = 0
        },
        Ocean = {
            Main = Color3.fromRGB(20, 35, 45), Secondary = Color3.fromRGB(15, 25, 35), ChannelBG = Color3.fromRGB(10, 20, 25), Outline = Color3.fromRGB(40, 70, 80), Text = Color3.fromRGB(230, 245, 255), TextSecondary = Color3.fromRGB(130, 170, 190), Accent = Color3.fromRGB(0, 200, 255), Success = Color3.fromRGB(0, 255, 150), Danger = Color3.fromRGB(255, 100, 100), Transparency = 0
        },
        Forest = {
            Main = Color3.fromRGB(25, 30, 25), Secondary = Color3.fromRGB(20, 25, 20), ChannelBG = Color3.fromRGB(15, 20, 15), Outline = Color3.fromRGB(50, 65, 50), Text = Color3.fromRGB(230, 240, 230), TextSecondary = Color3.fromRGB(140, 160, 140), Accent = Color3.fromRGB(100, 220, 100), Success = Color3.fromRGB(150, 255, 150), Danger = Color3.fromRGB(255, 120, 100), Transparency = 0
        },
        Amethyst = {
            Main = Color3.fromRGB(30, 20, 45), Secondary = Color3.fromRGB(25, 15, 35), ChannelBG = Color3.fromRGB(20, 10, 30), Outline = Color3.fromRGB(70, 50, 90), Text = Color3.fromRGB(245, 230, 255), TextSecondary = Color3.fromRGB(170, 140, 200), Accent = Color3.fromRGB(180, 100, 255), Success = Color3.fromRGB(150, 255, 150), Danger = Color3.fromRGB(255, 100, 150), Transparency = 0
        },
        Rose = {
            Main = Color3.fromRGB(45, 20, 30), Secondary = Color3.fromRGB(35, 15, 25), ChannelBG = Color3.fromRGB(30, 10, 20), Outline = Color3.fromRGB(90, 50, 70), Text = Color3.fromRGB(255, 230, 240), TextSecondary = Color3.fromRGB(200, 140, 170), Accent = Color3.fromRGB(255, 100, 180), Success = Color3.fromRGB(150, 255, 150), Danger = Color3.fromRGB(255, 80, 80), Transparency = 0
        },
        Sakura = {
            Main = Color3.fromRGB(255, 240, 245), Secondary = Color3.fromRGB(255, 225, 235), ChannelBG = Color3.fromRGB(255, 210, 225), Outline = Color3.fromRGB(255, 180, 200), Text = Color3.fromRGB(80, 40, 60), TextSecondary = Color3.fromRGB(150, 100, 120), Accent = Color3.fromRGB(255, 120, 180), Success = Color3.fromRGB(100, 200, 100), Danger = Color3.fromRGB(230, 60, 60), Transparency = 0
        },
        Emerald = {
            Main = Color3.fromRGB(10, 40, 30), Secondary = Color3.fromRGB(5, 30, 20), ChannelBG = Color3.fromRGB(0, 20, 15), Outline = Color3.fromRGB(30, 80, 60), Text = Color3.fromRGB(220, 255, 240), TextSecondary = Color3.fromRGB(120, 180, 160), Accent = Color3.fromRGB(40, 255, 150), Success = Color3.fromRGB(100, 255, 100), Danger = Color3.fromRGB(255, 100, 100), Transparency = 0
        },
        Void = {
            Main = Color3.fromRGB(0, 0, 0), Secondary = Color3.fromRGB(5, 5, 5), ChannelBG = Color3.fromRGB(10, 10, 10), Outline = Color3.fromRGB(30, 30, 30), Text = Color3.fromRGB(255, 255, 255), TextSecondary = Color3.fromRGB(120, 120, 120), Accent = Color3.fromRGB(255, 255, 255), Success = Color3.fromRGB(200, 200, 200), Danger = Color3.fromRGB(150, 0, 0), Transparency = 0
        }
    },
    Icons = {
...
function DeusUI:CreateWindow(config)
    ...
    self.UIScale = MainFrame.UIScale
    ...
    local function CreateControlButton(name, text, color)
        ...
        btn.MouseLeave:Connect(function() self:Tween(btn, TweenInfo.new(0.2), {BackgroundTransparency = 1, TextColor3 = self.Themes[self.CurrentTheme].TextSecondary}) end)
        return btn
    end

    local MinBtn = CreateControlButton("Min", "—")
    local CloseBtn = CreateControlButton("Close", "×", Color3.fromRGB(242, 63, 66))
    MinBtn.Parent = Controls; CloseBtn.Parent = Controls

    MinBtn.MouseButton1Click:Connect(function()
        local isMin = MainFrame.Size.Y.Offset < 100
        self:Tween(MainFrame, TweenInfo.new(0.4, Enum.EasingStyle.Quart), {Size = isMin and WindowSize or UDim2.new(0, 450, 0, 35)})
        Sidebar.Visible = isMin; PageContainer.Visible = isMin
    end)
    ...
    function Window:Tab(tabConfig)
        ...
        local function SetTabState(state)
            ...
            local targetText = state and current.Text or current.TextSecondary
            ...
            if state then
                DeusUI:Tween(TabBtn, TweenInfo.new(0.2), {BackgroundColor3 = current.Main, BackgroundTransparency = 0})
                DeusUI:Tween(TabBtn.Indicator, TweenInfo.new(0.2), {Size = UDim2.new(0, 3, 0, 18), BackgroundTransparency = 0, BackgroundColor3 = current.Accent})
            else
        ...
        function Tab:Button(btnConfig) 
            local Button = DeusUI:Create("TextButton", { Parent = Page, Size = UDim2.new(1, 0, 0, 34), BackgroundColor3 = DeusUI.Themes[DeusUI.CurrentTheme].Accent, Text = btnConfig.Title or "Button", TextColor3 = Color3.new(1,1,1), TextSize = 12, Font = Enum.Font.GothamBold, AutoButtonColor = false, ZIndex = 4 }, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(0, 4)}) })
        ...
        function Tab:Toggle(tConfig) 
            ...
            local ToggleFrame = DeusUI:Create("Frame", { Parent = Page, Size = UDim2.new(1, 0, 0, 36), BackgroundTransparency = 1, ZIndex = 4 }, { 
                DeusUI:Create("TextLabel", {Name = "T", Text = tConfig.Title or "Toggle", BackgroundTransparency = 1, TextColor3 = current.Text, TextSize = 13, Font = Enum.Font.GothamMedium, Size = UDim2.new(1, -50, 1, 0), TextXAlignment = "Left", ZIndex = 5}) 
            })
            table.insert(DeusUI.Elements, {Instance = ToggleFrame.T, Type = "TextColor"})
            local Switch = DeusUI:Create("TextButton", { Parent = ToggleFrame, Size = UDim2.new(0, 36, 0, 18), Position = UDim2.new(1, 0, 0.5, 0), AnchorPoint = Vector2.new(1, 0.5), BackgroundColor3 = toggled and current.Success or Color3.fromRGB(128, 132, 142), Text = "", ZIndex = 5 }, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(1, 0)}) })
            ...
            Switch.MouseButton1Click:Connect(function() 
                ...
                DeusUI:Tween(Switch, TweenInfo.new(0.2), {BackgroundColor3 = DeusUI.Themes[DeusUI.CurrentTheme].Success or Color3.fromRGB(128, 132, 142)})
        ...
        function Tab:Slider(sConfig) 
            ...
            local SliderFrame = DeusUI:Create("Frame", { Parent = Page, Size = UDim2.new(1, 0, 0, 45), BackgroundTransparency = 1, ZIndex = 4 }, { 
                DeusUI:Create("TextLabel", {Name = "T", Text = sConfig.Title or "Slider", BackgroundTransparency = 1, TextColor3 = current.Text, TextSize = 12, Font = Enum.Font.GothamMedium, Size = UDim2.new(0.7, 0, 0, 16), TextXAlignment = "Left", ZIndex = 5}), 
                DeusUI:Create("TextLabel", {Name = "Val", Text = tostring(val), BackgroundTransparency = 1, TextColor3 = current.TextSecondary, TextSize = 11, Font = Enum.Font.GothamBold, Size = UDim2.new(0.3, 0, 0, 16), Position = UDim2.new(0.7, 0, 0, 0), TextXAlignment = "Right", ZIndex = 5}) 
            })
            table.insert(DeusUI.Elements, {Instance = SliderFrame.T, Type = "TextColor"})
            local Bar = DeusUI:Create("Frame", {Parent = SliderFrame, Size = UDim2.new(1, 0, 0, 4), Position = UDim2.new(0, 0, 0, 28), BackgroundColor3 = current.ChannelBG, ZIndex = 5}, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(1, 0)}) })
            ...
            local Knob = DeusUI:Create("Frame", {Parent = Fill, Size = UDim2.new(0, 10, 0, 10), Position = UDim2.new(1, 0, 0.5, 0), AnchorPoint = Vector2.new(0.5, 0.5), BackgroundColor3 = Color3.new(1, 1, 1), ZIndex = 7}, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(1, 0)}), DeusUI:Create("UIStroke", {Color = current.Accent, Thickness = 1.5}) })
        ...
        function Tab:Dropdown(dConfig) 
            ...
            local current = DeusUI.Themes[DeusUI.CurrentTheme]
            local DropdownFrame = DeusUI:Create("Frame", { Parent = Page, Size = UDim2.new(1, 0, 0, 36), BackgroundColor3 = current.ChannelBG, ClipsDescendants = true, ZIndex = 4 }, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(0, 4)}), DeusUI:Create("UIStroke", {Color = current.Outline, Transparency = 0.5}) })
            ...
            local Title = DeusUI:Create("TextLabel", {Text = dConfig.Title or "Dropdown", Parent = Header, Size = UDim2.new(1, -100, 1, 0), Position = UDim2.new(0, 10, 0, 0), BackgroundTransparency = 1, TextColor3 = current.Text, Font = Enum.Font.GothamMedium, TextSize = 12, TextXAlignment = "Left", ZIndex = 6})
            table.insert(DeusUI.Elements, {Instance = Title, Type = "TextColor"})
            local SelText = DeusUI:Create("TextLabel", {Text = selected, Parent = Header, Size = UDim2.new(0, 80, 1, 0), Position = UDim2.new(1, -30, 0, 0), AnchorPoint = Vector2.new(1, 0), BackgroundTransparency = 1, TextColor3 = current.TextSecondary, Font = Enum.Font.Gotham, TextSize = 11, TextXAlignment = "Right", ZIndex = 6})
            local Arrow = DeusUI:Create("TextLabel", {Text = "▼", Parent = Header, Size = UDim2.new(0, 15, 1, 0), Position = UDim2.new(1, -8, 0, 0), AnchorPoint = Vector2.new(1, 0), BackgroundTransparency = 1, TextColor3 = current.TextSecondary, Font = Enum.Font.Gotham, TextSize = 9, ZIndex = 6})
            ...
            for _, val in pairs(dValues) do
                local Opt = DeusUI:Create("TextButton", { Parent = OptionHolder, Size = UDim2.new(1, 0, 0, 26), BackgroundTransparency = 1, Text = val, TextColor3 = current.TextSecondary, Font = Enum.Font.Gotham, TextSize = 11, TextXAlignment = "Left", ZIndex = 11 }, { DeusUI:Create("UIPadding", {PaddingLeft = UDim.new(0, 8)}) })
                Opt.MouseButton1Click:Connect(function() selected = val; SelText.Text = val; toggle(false); dConfig.Callback(val) end)
                Opt.MouseEnter:Connect(function() Opt.BackgroundTransparency = 0.9; Opt.BackgroundColor3 = Color3.new(1,1,1); Opt.TextColor3 = DeusUI.Themes[DeusUI.CurrentTheme].Text end)
                Opt.MouseLeave:Connect(function() Opt.BackgroundTransparency = 1; Opt.TextColor3 = DeusUI.Themes[DeusUI.CurrentTheme].TextSecondary end)
            end
        end

        function Tab:Colorpicker(cConfig) 
            local currentTheme = DeusUI.Themes[DeusUI.CurrentTheme]
            local current = cConfig.Default or currentTheme.Accent
            local ColorFrame = DeusUI:Create("Frame", { Parent = Page, Size = UDim2.new(1, 0, 0, 36), BackgroundTransparency = 1, ZIndex = 4 }, { 
                DeusUI:Create("TextLabel", {Name = "T", Text = cConfig.Title or "Color", BackgroundTransparency = 1, TextColor3 = currentTheme.Text, TextSize = 12, Font = Enum.Font.GothamMedium, Size = UDim2.new(1, -50, 1, 0), TextXAlignment = "Left", ZIndex = 5}) 
            })
            table.insert(DeusUI.Elements, {Instance = ColorFrame.T, Type = "TextColor"})
            local ColorView = DeusUI:Create("TextButton", { Parent = ColorFrame, Size = UDim2.new(0, 30, 0, 18), Position = UDim2.new(1, 0, 0.5, 0), AnchorPoint = Vector2.new(1, 0.5), BackgroundColor3 = current, Text = "", ZIndex = 5 }, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(0, 4)}), DeusUI:Create("UIStroke", {Color = currentTheme.Outline, Thickness = 1}) })
        ...
        function Tab:Keybind(kConfig) 
            ...
            local BindFrame = DeusUI:Create("Frame", { Parent = Page, Size = UDim2.new(1, 0, 0, 36), BackgroundTransparency = 1, ZIndex = 4 }, { DeusUI:Create("TextLabel", {Name = "T", Text = kConfig.Title or "Keybind", BackgroundTransparency = 1, TextColor3 = current.Text, TextSize = 12, Font = Enum.Font.GothamMedium, Size = UDim2.new(1, -80, 1, 0), TextXAlignment = "Left", ZIndex = 5}) })
            table.insert(DeusUI.Elements, {Instance = BindFrame.T, Type = "TextColor"})
            local Btn = DeusUI:Create("TextButton", { Parent = BindFrame, Size = UDim2.new(0, 60, 0, 22), Position = UDim2.new(1, 0, 0.5, 0), AnchorPoint = Vector2.new(1, 0.5), BackgroundColor3 = current.ChannelBG, Text = currentKey.Name, TextColor3 = current.Text, Font = Enum.Font.GothamBold, TextSize = 10, ZIndex = 5 }, { DeusUI:Create("UICorner", {CornerRadius = UDim.new(0, 4)}), DeusUI:Create("UIStroke", {Color = current.Outline, Transparency = 0.5}) })
        ...
        function Tab:Paragraph(pConfig) 
            local current = DeusUI.Themes[DeusUI.CurrentTheme]
            local ParaFrame = DeusUI:Create("Frame", { Parent = Page, Size = UDim2.new(1, 0, 0, 0), AutomaticSize = "Y", BackgroundColor3 = current.ChannelBG, BackgroundTransparency = 0.5, ZIndex = 4 }, { 
    ...
    function Window:Settings()
        ...
        SettingsTab:Dropdown({ Title = "Theme Presets", Values = ThemeNames, Default = DeusUI.CurrentTheme, Callback = function(t) 
            DeusUI.CurrentTheme = t
            DeusUI:UpdateUI()
        end })
        
        SettingsTab:Slider({ Title = "Transparency", Min = 0, Max = 100, Default = 0, Callback = function(v) 
            local val = v/100
            for _, theme in pairs(DeusUI.Themes) do theme.Transparency = val end
            DeusUI:UpdateUI() 
        end })

        SettingsTab:Colorpicker({ Title = "Background Color", Default = DeusUI.Themes[DeusUI.CurrentTheme].Main, Callback = function(c) 
            DeusUI.Themes[DeusUI.CurrentTheme].Main = c
            DeusUI:UpdateUI() 
        end })

        SettingsTab:Colorpicker({ Title = "Text Color", Default = DeusUI.Themes[DeusUI.CurrentTheme].Text, Callback = function(c) 
            for _, theme in pairs(DeusUI.Themes) do theme.Text = c end
            DeusUI:UpdateUI() 
        end })

        SettingsTab:Colorpicker({ Title = "Accent Color", Default = DeusUI.Themes[DeusUI.CurrentTheme].Accent, Callback = function(c) 
            for _, theme in pairs(DeusUI.Themes) do theme.Accent = c end
            DeusUI:UpdateUI() 
        end })
