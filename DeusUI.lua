...
function DeusUI:CreateWindow(config)
    ...
    local TabContainer = self:Create("ScrollingFrame", { Name = "TabScroll", Parent = Sidebar, Size = UDim2.new(1, -10, 1, -10), Position = UDim2.new(0, 5, 0, 10), BackgroundTransparency = 1, ScrollBarThickness = 0, AutomaticCanvasSize = "Y", ZIndex = 3 }, { self:Create("UIListLayout", {Padding = UDim.new(0, 5), HorizontalAlignment = "Center"}) })
