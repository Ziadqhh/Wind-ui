...
do
    ...
    function Library:CreateNotification(Title, Text, Duration)
        ...
        task.spawn(function()
            ...
            if not CoreGui:FindFirstChild('Visual UI Library | .gg/puxxCphTnK | Notifications') then
                ...
                Utility:Tween(Holder, {BackgroundTransparency = 0.8}, 0.35)
                Utility:Tween(TitleObj, {TextTransparency = 0.5}, 0.35)
                Utility:Tween(TextObj, {TextTransparency = 0.5}, 0.35)
                task.wait(0.5)
    ...
    function Library:CreatePrompt(Type, Title, Text, ...)
        ...
        if Type == 'Text' then
            ...
            Utility:Tween(PromptTitle, {Size = UDim2.new(0, TitleTextSize.X, 0, TitleTextSize.Y)}, 0.35)
            ...
            task.wait(0.35)
            Utility:Tween(ButtonStroke, {Thickness = 1.2}, 0.35)
            task.wait(0.35)
            Utility:Tween(PromptText, {TextTransparency = 0}, 0.35)
            Utility:Tween(PromptTitle, {TextTransparency = 0}, 0.35)
            Utility:Tween(Button, {BackgroundTransparency = 0}, 0.35)
            Utility:Tween(Button, {TextTransparency = 0}, 0.35)

            Button.MouseEnter:Connect(function(Input)
                Utility:Tween(Button, {TextColor3 = Utility:Lighten(Theme.PrimaryTextColor)}, 0.35)
            end)

            Button.MouseLeave:Connect(function(Input)
                Utility:Tween(Button, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
            end)
            
            Button.MouseButton1Down:Connect(function()
                Utility:Tween(Button, {BackgroundTransparency = 1}, 0.35)
                Utility:Tween(Button, {TextTransparency = 1}, 0.35)
                Utility:Tween(PromptText, {TextTransparency = 1}, 0.35)
                Utility:Tween(PromptTitle, {TextTransparency = 1}, 0.35)
                task.wait(0.35)
                Utility:Tween(ButtonStroke, {Thickness = 0}, 0.35)
                task.wait(0.35)
                Utility:Tween(PromptFrame, {BackgroundTransparency = 1}, 0.35)
                Utility:Tween(PromptFrame, {Size = UDim2.new(0, 0, 0, 0)}, 0.35)
                Utility:Tween(PromptFrameCorner, {CornerRadius = UDim.new(0, 18)}, 0.35)
                task.wait(0.35)
                Utility:Tween(PromptHolder, {BackgroundTransparency = 1}, 0.35)
                task.wait()
                PromptFrame:Destroy()
            end)
        ...
        elseif Type == 'TwoButton' then
            ...
            Utility:Tween(PromptFrameCorner, {CornerRadius = UDim.new(0, 12)}, 0.35)
            task.wait(0.35)
            Utility:Tween(Button1Stroke, {Thickness = 1.2}, 0.35)
            Utility:Tween(Button2Stroke, {Thickness = 1.2}, 0.35)
            task.wait(0.35)
            Utility:Tween(PromptText, {TextTransparency = 0}, 0.35)
            Utility:Tween(PromptTitle, {TextTransparency = 0}, 0.35)
            Utility:Tween(Button1, {BackgroundTransparency = 0}, 0.35)
            Utility:Tween(Button1, {TextTransparency = 0}, 0.35)
            Utility:Tween(Button2, {BackgroundTransparency = 0}, 0.35)
            Utility:Tween(Button2, {TextTransparency = 0}, 0.35)

            Button1.MouseEnter:Connect(function(Input)
                Utility:Tween(Button1, {TextColor3 = Utility:Lighten(Theme.PrimaryTextColor)}, 0.35)
            end)

            Button1.MouseLeave:Connect(function(Input)
                Utility:Tween(Button1, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
            end)
            
            Button1.MouseButton1Down:Connect(function()
                pcall(Button1Callback)
                Utility:Tween(Button1, {BackgroundTransparency = 1}, 0.35)
                Utility:Tween(Button1, {TextTransparency = 1}, 0.35)
                Utility:Tween(Button2, {BackgroundTransparency = 1}, 0.35)
                Utility:Tween(Button2, {TextTransparency = 1}, 0.35)
                Utility:Tween(PromptText, {TextTransparency = 1}, 0.35)
                Utility:Tween(PromptTitle, {TextTransparency = 1}, 0.35)
                task.wait(0.35)
                Utility:Tween(Button1Stroke, {Thickness = 0}, 0.35)
                Utility:Tween(Button2Stroke, {Thickness = 0}, 0.35)
                task.wait(0.35)
                Utility:Tween(PromptFrame, {BackgroundTransparency = 1}, 0.35)
                Utility:Tween(PromptFrame, {Size = UDim2.new(0, 0, 0, 0)}, 0.35)
                Utility:Tween(PromptFrameCorner, {CornerRadius = UDim.new(0, 18)}, 0.35)
            ...
            Button2.MouseEnter:Connect(function(Input)
                Utility:Tween(Button2, {TextColor3 = Utility:Lighten(Theme.PrimaryTextColor)}, 0.35)
            end)

            Button2.MouseLeave:Connect(function(Input)
                Utility:Tween(Button2, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
            end)
    ...
    for _, Item in next, UI:GetDescendants() do
        if not table.find(Blacklist, Item.ClassName) then
            if Item.BackgroundTransparency ~= 1 and Transparency < 0.95 then
                Utility:Tween(Item, {BackgroundTransparency = Transparency}, 0.35)
            end
        end
    end
...
function Library:CreateWindow(HubName, GameName, IntroText, IntroIcon, ImprovePerformance, ConfigFolder, Theme)
    ...
    Utility:Tween(Main, {BackgroundTransparency = 0}, 0.35)
    Utility:Tween(Main, {Size = UDim2.new(0, 650, 0, 0)}, 0.35)
    task.wait(0.5)
    Utility:Tween(Main, {Size = UDim2.new(0, 650, 0, 420)}, 0.35)
    task.wait(0.5)
    Utility:Tween(Main['IntroText'], {TextTransparency = 0}, 0.35)
    task.wait(0.5)
    Utility:Tween(Main['IntroImage'], {ImageTransparency = 0}, 0.35)
    task.wait(3)
    Utility:Tween(Main['IntroText'], {TextTransparency = 1}, 0.35)
    task.wait(0.5)
    Utility:Tween(Main['IntroImage'], {ImageTransparency = 1}, 0.35)
    task.wait(0.5)
    ...
    Utility:Create('Frame', {
        Name = 'Filler2',
        Parent = Main,
        Position = UDim2.new(0, 190, 0, 440),
        BorderSizePixel = 0,
        Size = UDim2.new(0, 459, 0, 10),
        ZIndex = 1,
        BackgroundColor3 = Theme.BackgroundColor
    ...
    Utility:Create('Frame', {
        ...
        Utility:Create('Frame', {
            Name = 'Filler3',
            Position = UDim2.new(0, 0, 0, 413),
            BorderSizePixel = 0,
            Size = UDim2.new(0, 190, 0, 7),
            ZIndex = 1,
            BackgroundColor3 = Theme.SidebarColor
        }, {
            Utility:Create('UICorner', {
    ...
    Utility:Create('Frame', {
        ...
        Parent = Main,
        BorderSizePixel = 0,
        Position = UDim2.new(0, 191, 0, 10),
        Size = UDim2.new(0, 459, 0, 400)
    }, {
    ...
    local HubNameTextSize = TextService:GetTextSize(HubNameObj.Text, 18, Enum.Font.Gotham, Vector2.new(440, math.huge))
    local GameNameTextSize = TextService:GetTextSize(GameNameObj.Text, 16, Enum.Font.Gotham, Vector2.new(440, math.huge))
    ...
    if HubNameTextSize.X >= 165 then
        ...
        repeat 
            ...
            local HubNameTextSize = TextService:GetTextSize(NewText, 18, Enum.Font.Gotham, Vector2.new(440, math.huge))
            X = HubNameTextSize.X
        until X < 165
        for _ = 1, 2 do
            NewText = NewText:sub(0, -2)
    ...
    if GameNameTextSize.X >= 175 then
        ...
        repeat 
            NewText = NewText:sub(0, -2)
            local GameNameTextSize = TextService:GetTextSize(NewText, 18, Enum.Font.Gotham, Vector2.new(440, math.huge))
    ...
    function UpdateTabButtonHolderSize()
        ...
        TabButtonHolder.CanvasSize = UDim2.new(0, 190, 0, ContentSize)
    end
            ...
            while task.wait() do
                if ChangeTheme then
                    if not BreakAllLoops then
                        Utility:Tween(Container.Main, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                        Utility:Tween(Container.Main.PromptHolder, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                        Utility:Tween(Container.Main.Filler1, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                        Utility:Tween(Container.Main.Filler2, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar, {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.NamesBehind, {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.Filler3, {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.HubNameText, {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.HubNameText, {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.GameNameText, {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.GameNameText, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.SidebarLine1, {BackgroundColor3 = Theme.UIStrokeColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.SidebarLine2, {BackgroundColor3 = Theme.UIStrokeColor}, 0.35)
                        Utility:Tween(Container.Main.Sidebar.TabButtonHolder, {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                        Utility:Tween(Container.Main.TabContainer, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                    else 
                        break
                    end
                end
    ...
    function Tabs:CreateTab(TabName, DefaultVisibility, Icon, RectOffset, RectSize)
            ...
            task.spawn(function()
                while task.wait() do
                    if ChangeTheme then
                        if not BreakAllLoops then
                            if Tab.Visible then
                                Utility:Tween(TabButtonHolder[TabName..'ButtonFrame'][TabName..'ButtonText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                Utility:Tween(TabButtonHolder[TabName..'ButtonFrame'][TabName..'ButtonImage'], {ImageColor3 = Theme.PrimaryTextColor}, 0.35)
                            else
                                Utility:Tween(TabButtonHolder[TabName..'ButtonFrame'][TabName..'ButtonText'], {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                Utility:Tween(TabButtonHolder[TabName..'ButtonFrame'][TabName..'ButtonImage'], {ImageColor3 = Theme.SecondaryTextColor}, 0.35)
                            end
                            Utility:Tween(Tab, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                            Utility:Tween(Tab, {ScrollBarImageColor3 = Theme.ScrollBarColor}, 0.35)
                            Utility:Tween(TabButtonHolder[TabName..'ButtonFrame'], {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                            Utility:Tween(TabButton, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                            Utility:Tween(TabButtonHolder[TabName..'ButtonFrame'][TabName..'ButtonImage'], {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                            Utility:Tween(TabButtonHolder[TabName..'ButtonFrame'][TabName..'ButtonText'], {BackgroundColor3 = Theme.SidebarColor}, 0.35)
                        else
                            break
                        end
                    end
        ...
        TabButton.MouseButton1Down:Connect(function()
            ...
            for _, Item in next, TabButtonHolder:GetDescendants() do
                if Item:IsA('TextLabel') then 
                    Utility:Tween(Item, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                elseif Item:IsA('ImageLabel') then
                    Utility:Tween(Item, {ImageColor3 = Theme.SecondaryTextColor}, 0.35)
                end
            end

            Utility:Tween(TabButton.Parent[TabName..'ButtonText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
            Utility:Tween(TabButton.Parent[TabName..'ButtonImage'], {ImageColor3 = Theme.PrimaryTextColor}, 0.35)
        end) 
        ...
        function Sections:CreateSection(Name)
            ...
            if not ImprovePerformance then
                task.spawn(function()
                    while task.wait() do
                        if ChangeTheme then
                            if not BreakAllLoops then
                                Utility:Tween(Section, {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                                Utility:Tween(Section[Name..'SectionLabel'], {BackgroundColor3 = Theme.BackgroundColor}, 0.35)
                                Utility:Tween(Section[Name..'SectionLabel'], {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                            else
                                break
                            end
                        end
            ...
            function UpdateSectionSize()
                ...
                Utility:Tween(Section, {Size = UDim2.new(0, ContentSize.X, 0, ContentSize.Y)}, 0.35)
            end
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    Utility:Tween(Section[LabelText..'LabelHolder'], {BackgroundColor3 = Theme.OtherElementColor}, 0.35)
                                    Utility:Tween(Section[LabelText..'LabelHolder'][LabelText..'LabelStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(Section[LabelText..'LabelHolder'][LabelText..'Label'], {BackgroundColor3 = Theme.OtherElementColor}, 0.35)
                                    Utility:Tween(Section[LabelText..'LabelHolder'][LabelText..'Label'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                else
                                    break
                                end
                            end
            ...
            function Elements:CreateParagraph(Title, Paragraph)
                ...
                local TextSizeOld = TextService:GetTextSize(Paragraph, 14, Enum.Font.Gotham, Vector2.new(440, math.huge))

                ParagraphHolder.Size = UDim2.new(0, 440, 0, TextSizeOld.Y + 25)
                ParagraphContent.Size = UDim2.new(0, 440, 0, TextSizeOld.Y)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    Utility:Tween(ParagraphHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ParagraphHolder[Title..'ParagraphStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(ParagraphTitle, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ParagraphTitle, {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(ParagraphContent, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ParagraphContent, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                else
                                    break
                                end
                            end
                ...
                function ParagraphFunctions:UpdateParagraph(NewTitle, NewParagraph)
                    ...
                    local TextSizeNew = TextService:GetTextSize(ParagraphContent.Text, 14, Enum.Font.Gotham, Vector2.new(440, math.huge))
                    local TextSizeOld = TextService:GetTextSize(Old, 14, Enum.Font.Gotham, Vector2.new(440, math.huge))
                    ...
                    if TextSizeNew.Y > 14 and TextSizeNew.Y > TextSizeOld.Y then
                        ...
                        ParagraphHolder.Size = UDim2.new(0, 440, 0, TextSizeNew.Y + 20)
                        ParagraphContent.Size = UDim2.new(0, 440, 0, TextSizeNew.Y)
            ...
            function Elements:CreateButton(Name, Callback)
                            ...
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if not Hovering then
                                        Utility:Tween(ButtonHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    end
                                    Utility:Tween(ButtonHolder[Name..'ButtonHolderStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(Button, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(Button, {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(Button['ButtonImage'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(Button['ButtonImage'], {ImageColor3 = Theme.SecondaryTextColor}, 0.35)
                                else
                                    break
                                end
                            end
                ...
                Button.MouseButton1Down:Connect(function()
                    Hovering = true
                    Utility:Tween(ButtonHolder, {BackgroundColor3 = Utility:Darken(Theme.PrimaryElementColor)}, 0.35)
                    task.spawn(function()
                        Callback()
                    end)
                    task.wait(0.35)
                ...
                Button.MouseEnter:Connect(function()
                    Hovering = true
                    Utility:Tween(ButtonHolder, {BackgroundColor3 = Utility:Lighten(Theme.PrimaryElementColor)}, 0.35)
                end)
            ...
            function Elements:CreateSlider(Name, MinimumValue, MaximumValue, DefaultValue, SliderColor, Callback)
                    ...
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if not Hovering then
                                        Utility:Tween(SliderHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    end
                                    Utility:Tween(SliderHolder[Name..'SliderHolderStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(SliderHolder['SliderText'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(SliderHolder['SliderText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(SliderButton, {BackgroundColor3 = Theme.SecondaryElementColor}, 0.35)
                                    Utility:Tween(SliderButton[Name..'SliderButtonStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(SliderNumber, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(SliderNumber, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                else
                                    break
                                end
                            end
                ...
                if DefaultValue ~= nil then
                    ...
                    Utility:Tween(SliderTrail, {Size = UDim2.new((DefaultValue) / MaximumValue, 0, 0, 10)}, 0.35)  
                    task.spawn(function()
                ...
                SliderButton.MouseButton1Down:Connect(function()
                    CurrentValue = (((tonumber(MaximumValue) - tonumber(MinimumValue)) / 425) * SliderTrail.AbsoluteSize.X) + tonumber(MinimumValue)
                    task.spawn(function()
                        Callback(CurrentValue)
                    end)
                    Utility:Tween(SliderTrail, {Size = UDim2.new(0, math.clamp(Mouse.X - SliderTrail.AbsolutePosition.X, 0, 425), 0, 10)}, 0.35)
                    MoveConnection = Mouse.Move:Connect(function()
                        SliderNumber.Text = CurrentValue
                        CurrentValue = math.floor((((tonumber(MaximumValue) - tonumber(MinimumValue)) / 425) * SliderTrail.AbsoluteSize.X) + tonumber(MinimumValue))
                        task.spawn(function()
                            Callback(CurrentValue)
                        end)
                        Config[Name] = CurrentValue
                        Utility:Tween(SliderNumber, {TextColor3 = Color3.new(255, 255, 255)}, 0.35)
                        Utility:Tween(SliderTrail, {Size = UDim2.new(0, math.clamp(Mouse.X - SliderTrail.AbsolutePosition.X, 0, 425), 0, 10)}, 0.35)
                    end)
                ...
                SliderHolder.MouseEnter:Connect(function()
                    Hovering = true
                    Utility:Tween(SliderHolder, {BackgroundColor3 = Utility:Lighten(Theme.PrimaryElementColor)}, 0.35)
                end)
                ...
                function SliderFunctions:Set(Value)
                    ...
                    Utility:Tween(SliderTrail, {Size = UDim2.new((Value) / MaximumValue, 0, 0, 10)}, 0.35)  
                    Callback(Value)
                end
            ...
            function Elements:CreateTextbox(Name, Placeholder, Callback)
                    ...
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if not Hovering then
                                        Utility:Tween(TextboxHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    end
                                    Utility:Tween(TextboxHolder[Name..'TextboxHolderStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(TextboxHolder[Name..'TextboxText'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(TextboxHolder[Name..'TextboxText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(Textbox, {BackgroundColor3 = Theme.SecondaryElementColor}, 0.35)
                                    Utility:Tween(Textbox, {PlaceholderColor3 = Theme.SecondaryTextColor}, 0.35)
                                    Utility:Tween(Textbox, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                    Utility:Tween(Textbox[Name..'TextboxStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                else
                                    break
                                end
                            end
                ...
                local TextSize = TextService:GetTextSize(Placeholder, 14, Enum.Font.Gotham, Vector2.new(440, 40))

                if TextSize.X < 50 then 
                    Utility:Tween(Textbox, {Size = UDim2.new(0, 50, 0, 25)}, 0.35)
                else
                    Utility:Tween(Textbox, {Size = UDim2.new(0, TextSize.X + 10, 0, 25)}, 0.35)
                end

                Textbox.Focused:Connect(function()
                    Hovering = true
                    Utility:Tween(Textbox, {BackgroundColor3 = Utility:Lighten(Theme.SecondaryElementColor)}, 0.35)
                    Utility:Tween(TextboxHolder, {BackgroundColor3 = Utility:Lighten(Theme.PrimaryElementColor)}, 0.35)
                end)
                ...
                Textbox.Changed:Connect(function(Property)
                    if Property == 'Text' then
                        Utility:Tween(Textbox, {TextColor3 = Theme.PrimaryTextColor}, 0.35)

                        local TextSize = TextService:GetTextSize(Textbox.Text, 14, Enum.Font.Gotham, Vector2.new(440, 40))
            ...
            function Elements:CreateKeybind(Name, Key, Callback)
                    ...
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if not Hovering then
                                        Utility:Tween(KeybindHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    end
                                    Utility:Tween(KeybindHolder[Name..'KeybindHolderStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(KeybindHolder[Name..'KeybindText'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(KeybindHolder[Name..'KeybindText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(KeybindHolder[Name..'Keybind'], {BackgroundColor3 = Theme.SecondaryElementColor}, 0.35)
                                    Utility:Tween(KeybindHolder[Name..'Keybind'], {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                    Utility:Tween(KeybindHolder[Name..'Keybind'][Name..'KeybindStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                else
                                    break
                                end
                            end
                ...
                TextSize = TextService:GetTextSize(Current, 14, Enum.Font.Gotham, Vector2.new(440, 40))
                if TextSize.X < 25 then
                    Utility:Tween(Keybind, {Size = UDim2.new(0, 25, 0, 25)}, 0.35)
                else 
                    Utility:Tween(Keybind, {Size = UDim2.new(0, TextSize.X + 10, 0, 25)}, 0.35)
                end

                Keybind.MouseButton1Click:Connect(function()
                    Keybind.Text = '. . .'
                    Utility:Tween(KeybindHolder, {BackgroundColor3 = Utility:Lighten(Theme.PrimaryElementColor)}, 0.35)
                    local Input, _ = UserInputService.InputBegan:wait();

                    if Input.KeyCode.Name ~= 'Unknown' then
                        Keybind.Text = Input.KeyCode.Name
                        TextSize = TextService:GetTextSize(Input.KeyCode.Name, 14, Enum.Font.Gotham, Vector2.new(440, 40))
                        if TextSize.X < 25 then
                            Utility:Tween(Keybind, {Size = UDim2.new(0, 25, 0, 25)}, 0.35)
                        else 
                            Utility:Tween(Keybind, {Size = UDim2.new(0, TextSize.X + 10, 0, 25)}, 0.35)
            ...
            function Elements:CreateToggle(Name, Default, ToggleColor, DebounceAmount, Callback)
                ...
                local DebounceAmount = DebounceAmount or 0.35
                    ...
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if not Hovering then
                                        Utility:Tween(ToggleHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    end
                                    Utility:Tween(ToggleHolder[Name..'ToggleHolderStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(ToggleHolder[Name..'ToggleText'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ToggleHolder[Name..'ToggleText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(ToggleHolder[Name..'Toggle'][Name..'ToggleCircle'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ToggleHolder[Name..'Toggle'][Name..'ToggleStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(ToggleHolder[Name..'ToggleButton'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                else
                                    break
                                end
                            end
                            ...
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if Toggled == true then
                                        Utility:Tween(Toggle, {BackgroundColor3 = ToggleColor}, 0.35)
                                    else
                                        Utility:Tween(ToggleHolder[Name..'Toggle'], {BackgroundColor3 = Theme.SecondaryElementColor}, 0.35)
                                    end
                                else
                                    break
                                end
                ...
                if Default then
                    ...
                    Utility:Tween(Toggle, {BackgroundColor3 = ToggleColor}, 0.35)
                    Utility:Tween(Circle, {Position = UDim2.new(0, 30, 0, 5)}, 0.35)
                end
                ...
                ToggleButton.MouseButton1Down:Connect(function()
                    if not Debounce then
                        ...
                        if Toggled then
                            ...
                            Utility:Tween(Toggle, {BackgroundColor3 = Theme.SecondaryElementColor}, 0.35)
                            Utility:Tween(Circle, {Position = UDim2.new(0, 5, 0, 5)}, 0.35)
                        end
            ...
            function Elements:CreateDropdown(Name, List, Default, DebounceAmount, Callback)
                    ...
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if not Hovering then
                                        Utility:Tween(DropdownHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    end
                                    Utility:Tween(DropdownHolder[Name..'DropdownHolderStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(DropdownHolder[Name..'DropdownText'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(DropdownHolder[Name..'DropdownText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(DropdownIcon, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(DropdownIcon, {ImageColor3 = Theme.SecondaryTextColor}, 0.35)
                                    Utility:Tween(DropdownSelectedText, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(DropdownSelectedText, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                    Utility:Tween(DropList, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(DropList, {ScrollBarImageColor3 = Theme.ScrollBarColor}, 0.35)
                                    Utility:Tween(DropList[Name..'DropListStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(DropdownButton, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                else
                                    break
                                end
                            end
                ...
                DropdownButton.MouseButton1Click:Connect(function()
                    ...
                    if not Debounce then
                        if Opened then
                            Opened = false
                            Utility:Tween(DropdownFiller, {Size = UDim2.new(0, 440, 0, 0)}, 0.35)
                            Utility:Tween(DropList, {Size = UDim2.new(0, 440, 0, 0)}, 0.35)
                            Utility:Tween(DropdownIcon, {Rotation = 270}, 0.35)
                            if #List <= 5 then
                                Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0, 0, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.35)
                                Utility:Tween(Section, {Size = Section.Size - UDim2.new(0, 0, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.35)
                            else
                                Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0, 0, 0, 150)}, 0.35)
                                Utility:Tween(Section, {Size = Section.Size - UDim2.new(0, 0, 0, 150)}, 0.35)
                            end
                            Debounce = true
                            task.wait(DebounceAmount)
                            Debounce = false
                            ...
                            if #List <= 5 then
                                Utility:Tween(DropList, {Size = UDim2.new(0, 440, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.35)
                                Utility:Tween(DropdownFiller, {Size = UDim2.new(0, 440, 0, DropListLayout.AbsoluteContentSize.Y - 6)}, 0.35)
                                Utility:Tween(DropList, {CanvasSize = UDim2.new(0, 430, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.35)
                                Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize + UDim2.new(0, 0, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.35)
                                Utility:Tween(Section, {Size = Section.Size + UDim2.new(0, 0, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.35)
                            else
                                Utility:Tween(DropList, {Size = UDim2.new(0, 440, 0, 150)}, 0.35)
                                Utility:Tween(DropList, {CanvasSize = UDim2.new(0, 430, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.35)
                                Utility:Tween(DropdownFiller, {Size = UDim2.new(0, 440, 0, 144)}, 0.35)
                                Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize + UDim2.new(0, 0, 0, 150)}, 0.35)
                                Utility:Tween(Section, {Size = Section.Size + UDim2.new(0, 0, 0, 150)}, 0.35)
                            end
                            Utility:Tween(DropdownIcon, {Rotation = 90}, 0.35)
                            Debounce = true
                            task.wait(DebounceAmount)
                            Debounce = false
                        end
                ...
                for _, Item in next, List do
                        ...
                        task.spawn(function()
                            while task.wait() do
                                if ChangeTheme then
                                    if not BreakAllLoops then
                                        if not Hovering then
                                            Utility:Tween(OptionButton, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                        end
                                        Utility:Tween(OptionButton, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                    else
                                        break
                                    end
                                end
                    ...
                    OptionButton.MouseButton1Click:Connect(function()
                        ...
                        Utility:Tween(OptionButton, {BackgroundColor3 = Utility:Lighten(Theme.PrimaryElementColor)}, 0.35)
                ...
                if Default ~= nil then
                    ...
                    Utility:Tween(Option, {BackgroundColor3 = Utility:Lighten(Theme.PrimaryElementColor)}, 0.35)
                ...
                function DropdownFunctions:UpdateDropdown(NewList)
                    ...
                    if Opened then
                        ...
                        Utility:Tween(DropdownIcon, {Rotation = 270}, 0.35)
                        if #List <= 5 then
                            Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0, 0, 0, DropListLayout.AbsoluteContentSize.Y + 150)}, 0.35)
                            Utility:Tween(Section, {Size = Section.Size - UDim2.new(0, 0, 0, DropListLayout.AbsoluteContentSize.Y + 150)}, 0.35)
                        else
                            Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0, 0, 0, 90)}, 0.35)
                            Utility:Tween(Section, {Size = Section.Size - UDim2.new(0, 0, 0, 90)}, 0.35)
                        end
                        Debounce = true
                        task.wait(DebounceAmount)
                        Debounce = false
            ...
            function Elements:CreateImage(Name, URL, ImageSize)
                    ...
                    task.spawn(function()
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    if not Hovering then
                                        Utility:Tween(ImageHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    end
                                    Utility:Tween(ImageHolder[Name..'ImageStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(ImageHolder[Name..'ImageText'], {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ImageHolder[Name..'ImageText'], {TextColor3 = Theme.PrimaryTextColor}, 0.35)
                                    Utility:Tween(ImageIcon, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ImageIcon, {ImageColor3 = Theme.SecondaryTextColor}, 0.35)
                                    Utility:Tween(ImageDropdown, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(ImageDropdown, {ScrollBarImageColor3 = Theme.ScrollBarColor}, 0.35)
                                    Utility:Tween(ImageDropdown[Name..'ImageDropdownStroke'], {Color = Theme.UIStrokeColor}, 0.35)
                                    Utility:Tween(Image, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                    Utility:Tween(Button, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.35)
                                else
                                    break
                                end
                ...
                Button.MouseButton1Click:Connect(function()
                    if not Debounce then
                        if Opened then
                            Opened = false
                            Utility:Tween(ImageFiller, {Size = UDim2.new(0, 440, 0, 0)}, 0.35)
                            Utility:Tween(ImageDropdown, {Size = UDim2.new(0, 440, 0, 0)}, 0.35)
                            Utility:Tween(ImageIcon, {ImageColor3 = Theme.SecondaryTextColor}, 0.35)
                            Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0, 430, 0, ImageSize.Y.Offset + 10)}, 0.35)
                            Utility:Tween(Section, {Size = Section.Size - UDim2.new(0, 430, 0, ImageSize.Y.Offset + 10)}, 0.35)
                            Utility:Tween(Image, {Size = UDim2.new(0, 440, 0, 0)}, 0.35)
                            UpdateImageCanvas()
                            UpdateSectionSize()
                            Debounce = true
                            task.wait(DebounceAmount)
                            ...
                            Utility:Tween(ImageDropdown, {Size = UDim2.new(0, 440, 0, ImageSize.Y.Offset + 10)}, 0.35)
                            Utility:Tween(ImageFiller, {Size = UDim2.new(0, 440, 0, ImageSize.Y.Offset + 10 - 6)}, 0.35)
                            Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize + UDim2.new(0, 0, 0, ImageSize.Y.Offset + 10)}, 0.35)
                            Utility:Tween(Section, {Size = Section.Size + UDim2.new(0, 0, 0, ImageSize.Y.Offset + 10)}, 0.35)
                            Utility:Tween(Image, {Size = ImageSize}, 0.35)
                            UpdateImageCanvas()
                            UpdateSectionSize()
                            Utility:Tween(ImageIcon, {ImageColor3 = Theme.PrimaryTextColor}, 0.35)
                            Debounce = true
                            task.wait(DebounceAmount)
                            Debounce = false
                        end
                ...
                Image.InputBegan:Connect(function(Input)
                    if not Debounce2 then
                        ...
                        UpdateImageCanvas()
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                            Utility:Tween(Image, {Size = UDim2.new(0, Image.Size.X.Offset * 2, 0, Image.Size.Y.Offset * 2)}, 0.35)
                            UpdateImageCanvas()
                ...
                Image.Changed:Connect(function(Property)
                    if Property == 'Size' then
                        if Image.Size == ImageSize then
                            Utility:Tween(ImageDropdown, {CanvasSize = ImageSize}, 0.35)
                        end 
                    end
                end)
