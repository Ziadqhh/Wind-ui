...
function Library:CreateWindow(HubName, GameName, IntroText, IntroIcon, ImprovePerformance, ConfigFolder, Theme, WindowSize)
    local WindowSize = WindowSize or UDim2.new(0, 480, 0, 320)
    ...
    Utility:Tween(Main, {Size = UDim2.new(0, WindowSize.X.Offset, 0, 0)}, 0.35)
    task.wait(0.5)
    Utility:Tween(Main, {Size = WindowSize}, 0.35)
    task.wait(0.5)
    ...
    Utility:Create('Frame', {
        ...
        Parent = Main,
        BorderSizePixel = 0,
        Size = UDim2.new(0, 170, 0, WindowSize.Y.Offset)
    }, {
        Utility:Create('UICorner', {
            CornerRadius = UDim.new(0, 12),
            Name = 'SidebarCorner'
    ...
    function Library:SetSize(NewSize)
        WindowSize = NewSize
        Utility:Tween(Main, {Size = WindowSize}, 0.35)
        ...
        function Sections:CreateSection(Name)
            ...
            function Elements:CreateSlider(Name, MinimumValue, MaximumValue, DefaultValue, SliderColor, Callback)
                ...
                local SliderHolder = Utility:Create('Frame', {
                    ...
                    Utility:Create('Frame', {
                        Name = Name..'SliderBack',
                        BackgroundColor3 = Theme.SecondaryElementColor,
                        Position = UDim2.new(0, 10, 0, 32),
                        Size = UDim2.new(0, 420, 0, 4),
                        BorderSizePixel = 0
                    }, {
                        Utility:Create('UICorner', {
                            CornerRadius = UDim.new(0, 12)
                        ...
                        Utility:Create('Frame', {
                            ...
                            Size = UDim2.new((DefaultValue - MinimumValue) / (MaximumValue - MinimumValue), 0, 1, 0),
                            BorderSizePixel = 0
                        }, {
                            Utility:Create('UICorner', {
                                CornerRadius = UDim.new(0, 12)
                            ...
                            Utility:Create('Frame', {
                                Name = Name..'SliderKnob',
                                AnchorPoint = Vector2.new(0.5, 0.5),
                                BackgroundColor3 = Theme.PrimaryTextColor,
                ...
                local SliderBack = SliderHolder[Name..'SliderBack']
                local SliderTrail = SliderBack[Name..'SliderTrail']
                local SliderNumber = SliderHolder[Name..'SliderNumberText']
                local SliderKnob = SliderTrail[Name..'SliderKnob']
                ...
                local function UpdateSlider(Input)
                    ...
                    local Value = math.floor(((MaximumValue - MinimumValue) * Percentage) + MinimumValue)
                        ...
                        while task.wait() do
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    Utility:Tween(SliderBack, {BackgroundColor3 = Theme.SecondaryElementColor}, 0.35)
                                    Utility:Tween(SliderNumber, {TextColor3 = Theme.SecondaryTextColor}, 0.35)
                                    Utility:Tween(SliderKnob, {BackgroundColor3 = Theme.PrimaryTextColor}, 0.35)
                                else break end
                            end
                        end
                    end)
                ...
                SliderHolder.MouseEnter:Connect(function()
                    Hovering = true
                    Utility:Tween(SliderHolder, {BackgroundColor3 = Utility:Lighten(Theme.PrimaryElementColor)}, 0.3)
                end)

                SliderHolder.MouseLeave:Connect(function()
                    Hovering = false
                    Utility:Tween(SliderHolder, {BackgroundColor3 = Theme.PrimaryElementColor}, 0.3)
                end)

                function SliderFunctions:Set(Value)
                    local Percentage = math.clamp((Value - MinimumValue) / (MaximumValue - MinimumValue), 0, 1)
                    CurrentValue = Value
                    SliderNumber.Text = tostring(Value)
                    Utility:Tween(SliderTrail, {Size = UDim2.new(Percentage, 0, 1, 0)}, 0.2)
                    Callback(Value)
                end
